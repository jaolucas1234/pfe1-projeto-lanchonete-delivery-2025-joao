...
function listarPedidos() {
    ...
    pedidos.forEach(pedido => {
        ...
        if (pedido.status === "execucao") {
            btn.innerHTML = `
                <img src="../assets/check.png" alt="Ícone de entrega" style="width: 25px; height: 25px; margin-right: 5px;">
                Enviar Entrega
            `;
            ...
            btn.innerHTML = `
                <img src="../assets/icone.png" alt="Ícone de pedido entregue" style="width: 25px; height: 25px; margin-right: 5px;">
                Pedido entregue
            `;
...
function finalizarPedido(id, horaEntrega) {
    ...
    pedido.preco = calcularPreco(pedido.produto);
